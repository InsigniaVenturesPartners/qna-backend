...
#Create Topics
t1 = Topic.find_or_create_by(name: "Business", description: "Business is the activity of making one's living or making money by producing or buying and selling products (such as goods and services). Simply put, it is any activity or enterprise entered into for profit.", pic_url: "https://s3-ap-southeast-1.amazonaws.com/qna-resources/assets/business.png")
t2 = Topic.find_or_create_by(name: "Technology", description: "Technology is the collection of techniques, skills, methods, and processes used in the production of goods or services or in the accomplishment of objectives, such as scientific investigation", pic_url: "https://s3-ap-southeast-1.amazonaws.com/qna-resources/assets/technology.png")
t3 = Topic.find_or_create_by(name: "Product", description: "", pic_url: "https://s3-ap-southeast-1.amazonaws.com/qna-resources/assets/product.png")
t4 = Topic.find_or_create_by(name: "Marketing", description: "", pic_url: "https://s3-ap-southeast-1.amazonaws.com/qna-resources/assets/marketing.png")
t5 = Topic.find_or_create_by(name: "Hiring", description: "", pic_url: "https://s3-ap-southeast-1.amazonaws.com/qna-resources/assets/hiring.png")
